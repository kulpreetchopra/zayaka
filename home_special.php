...
<div class="container-fluid footer">
  <div class="row">
    <div class="col-md-12">
      <center><h3  style="background-color:<?php echo $theme['color']?>"><?php echo $result['tittle']?></h3></center>
    </div><!-- col md 12 end-->
  </div> <!-- row end-->
</div>
<br>
     ...
     ?>
      <div class="col-lg-4 col-md-6 special-grid drinks inner animate__animated animate__zoomIn">
        <div class="gallery-single fix">
          ...
          <a style="text-decoration:none" href="<?php echo $result['link']?>?id=<?php echo $result['id']?>&username=<?php echo $name?>&tablen=<?php echo $table?>">
            <div class="why-text">
              ...
              <p><?php echo $result['about']?>
              </p>
              <p>Item Number: <?php echo $result['item_no']?></p>
              <h5>₹ <?php echo $result['price']?>
              </h5>
            </div>
          </a>
        </div>
