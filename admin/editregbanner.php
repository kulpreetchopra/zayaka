...
{
$id =$_GET['id'];
$query ="select * From registrationbanner where id=$id";
...
include('dbcon.php');
  ...
  if(isset($_POST['submit'])){
   ...
   $q ="UPDATE registrationbanner SET name='$name',image='$folder',tittle='$tittle' WHERE id=$id";

   $fire =mysqli_query($con, $q);
    // if($fire)echo "data updated successfully.";
  	if($fire) header("Location:viewregbanner.php");
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"><i class="fas fa-edit"></i>&nbsp;<a href="viewregbanner.php"><i class="fas fa-eye"></i></a></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
