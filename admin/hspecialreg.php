...
$sql = "INSERT INTO homespecial(tittle,item_no,name,image,link,price,about)VALUES('$tittle','$item_no','$name','$image','$link','$price','$about');";

  
  if(mysqli_query($con, $sql)){
    header("location:addhspecial.php");
  }else{
