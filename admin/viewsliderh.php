...
$file1 =explode(".", $file); //image.jpg Arrays
 ...
 move_uploaded_file($tmp_name,$path);
    $query ="UPDATE homeslider SET image = '$path'where id='$id' ";
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"><i class="fas fa-eye"></i>&nbsp;<a href="addsliderh.php"><i class="fas fa-user-edit"></i></a></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
  ...
  ?>
        ...
        <a href="sliderhedit.php?id=<?php echo $result['id']?>"><i class="fas fa-edit"></i>&nbsp;</a>
        <a href="sliderhdelet.php?id=<?php echo $result['id']?>">&nbsp;<i class="fas fa-trash"></i></a>
        </td>
      </tr>
