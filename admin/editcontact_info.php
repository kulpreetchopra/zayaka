...
include('dbcon.php');
  ...
  if(isset($_POST['submit'])){
   ...
   $q ="UPDATE contact_info SET tittle='$tittle',contact='$contact' WHERE id=$id";

  $fire =mysqli_query($con, $q);
    // if($fire)echo "data updated successfully.";
    if($fire) header("Location:viewcontact_info.php");
}
?>
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"><i class="fas fa-edit"></i>&nbsp;<a href="viewcontact_info.php"><i class="fas fa-eye"></i></a></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
