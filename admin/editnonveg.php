...
{
$id =$_GET['id'];
$query ="select * From nonveg where id=$id";
...
include('dbcon.php');
  ...
  if(isset($_POST['submit'])){
   ...
   $q ="UPDATE nonveg SET tittle='$tittle',item_no='$item_no',name='$name',link='$link',image='$folder',price='$price',about='$about' WHERE id=$id";

   $fire =mysqli_query($con, $q);
    // if($fire)echo "data updated successfully.";
    if($fire) header("Location:viewnonveg.php");
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"><i class="fas fa-edit"></i>&nbsp;<a href="viewnonveg.php"><i class="fas fa-eye"></i></a></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Edit NonVeg</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
