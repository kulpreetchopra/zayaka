...
<div class="login-box">
  <div class="login-logo">
    <h1 class="blog-name pt-lg-4 mb-0" style="color: white">User Profile</h1>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    ...
    background-size: cover;">
      ...
      <form action="login.php" onsubmit="return userlogin()" method="post">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-4">
            <a href="../index.php?username=<?php echo $name?>" class="btn btn-block btn-primary">Cancel
        </a>
      ...
      <p align="center">--OR--</p>
        ...
        <a href="../registration.php?username=<?php echo $name?>"  class="btn btn-block btn-danger">
          <i class="fas fa-user-edit"></i> New User Registered Now
        </a>
      </div>
      <!-- /.social-auth-links -->
    </div>
